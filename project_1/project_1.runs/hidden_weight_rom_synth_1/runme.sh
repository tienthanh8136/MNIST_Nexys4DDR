...
HD_PWD='C:/Users/Thanh/Desktop/MIST_Nexys4/project_1/project_1.runs/hidden_weight_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hidden_weight_rom.vds -m64 -mode batch -messageDb vivado.pb -notrace -source hidden_weight_rom.tcl

...
#
# Generated by export_simulation on Sun Apr 22 20:22:16 -0700 2018
#
################################################################################
...
switch to the './hidden_layer_weight.sh' script.

./hidden_layer_weight.sh -reset_run
...
./hidden_layer_weight.sh -noclean_files

For more information on the script, please type './hidden_layer_weight.sh -help'.

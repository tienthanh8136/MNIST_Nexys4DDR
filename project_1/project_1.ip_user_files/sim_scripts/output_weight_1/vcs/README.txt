...
#
# Generated by export_simulation on Sun Apr 22 20:11:27 -0700 2018
#
################################################################################
...
switch to the './output_weight_1.sh' script.

./output_weight_1.sh -reset_run
...
./output_weight_1.sh -noclean_files

For more information on the script, please type './output_weight_1.sh -help'.

...
HD_PWD='C:/Users/Thanh/Desktop/MIST_Nexys4/project_1/project_1.runs/output_weight_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log output_weight_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source output_weight_0.tcl

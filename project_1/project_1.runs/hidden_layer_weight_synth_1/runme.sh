...
HD_PWD='C:/Users/Thanh/Desktop/MIST_Nexys4/project_1/project_1.runs/hidden_layer_weight_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hidden_layer_weight.vds -m64 -mode batch -messageDb vivado.pb -notrace -source hidden_layer_weight.tcl

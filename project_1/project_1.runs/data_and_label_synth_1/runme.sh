...
HD_PWD='C:/Users/Thanh/Desktop/MIST_Nexys4/project_1/project_1.runs/data_and_label_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log data_and_label.vds -m64 -mode batch -messageDb vivado.pb -notrace -source data_and_label.tcl
